...
export default {
  ...
  data () {
    ...
    this.$http.get('http://34.73.201.101:8000/api/v1/message',{ headers: 
      { Authorization: token }
      }).then((result) => {
        this.items = result.data
      })
    
    this.$http.get('http://34.73.201.101:8000/api/v1/users',{ headers: 
      { Authorization: token }
      }).then((result) => {
    ...
    createMessage: function () {
     ...
     toggleModal() {
       ...
       this.$http.post('http://34.73.201.101:8000/api/v1/message', formData,{ headers: 
      { Authorization: token }
      }).then((result) => {
