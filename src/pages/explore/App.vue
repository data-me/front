...
export default {
  ...
  data () {
    ...
    this.$http.get('http://api-datame.herokuapp.com/api/v1/offer',{ headers:
      { Authorization: token }
      }).then((result) => {
      ...
      toggleCreateApply() {
       ...
       this.$http.post('hhttp://api-datame.herokuapp.com/api/v1/apply', formApply,{ headers:
      { Authorization: token }
      }).then((result) => {
    ...
    this.offerId = idOffer
     ...
     toggleModal() {
       ...
       this.$http.post('http://api-datame.herokuapp.com/api/v1/offer', formData,{ headers:
      { Authorization: token }
      }).then((result) => {
          alert(result.data.message)
          location.reload()
      ...
      onSubmit() {
        ...
        this.$http.get(`http://api-datame.herokuapp.com/api/v1/offer?search=${this.form.search}`,{ headers:
