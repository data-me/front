          ...
          <b-card no-body>
            ...
            <b-collapse :id="'accordion-'+index" accordion="my-accordion" role="tabpanel">
              <b-card-body>
                ...
                <b-card-text><span class="font-weight-bold">Contract:</span> {{item.contract}}</b-card-text>
                <b-card-text><span class="font-weight-bold">File:</span> {{item.files}}</b-card-text>
